...
import Logo from '../../assets/side-by-side-transparent-bg-logo.png'

const Footer = () => {
  return (
    <footer className="p-4 bg-[#fcded3] sm:p-6 dark:bg-gray-900">
    <div className="bg-[#fcded3] md:flex md:justify-between">
        <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
                <img src={Logo} className="bg-[#fcded3] mr-3 w-full h-full " alt="Project Choice Logo" />
            </a>
        </div>
        <div className="bg-[#fcded3] grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
