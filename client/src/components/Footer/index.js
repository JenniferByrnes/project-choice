const Footer = () => {
    return (
        <footer className=" bg-neutral-200 text-neutral-600">
            ...
            <div className="container max-w-6xl py-10 mx-auto">
                ...
                <div className="flex flex-col items-center space-y-6 md:flex-row md:space-y-0 md:justify-between md:items-start">
                    ...
                    <div className='flex flex-col items-center space-y-8 md:items-start md:space-y-4'>
                        ...
                        {/* Menu Container */}
                        <ul className="flex flex-col items-center space-y-2 md:flex-row md:space-y-0 md:space-x-6 md:ml-3">
                            <li>
            ...
            <hr className="hidden my-6 mx-auto lg:my-8" />
            <div className="flex flex-col items-center justify-between space-y-2" >
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="https://github.com/JenniferByrnes/project-choice" className="text-gray-500 hover:text-gray-900">
