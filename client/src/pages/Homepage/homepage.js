              ...
              <div className="bg-white px-4 py-5 sm:p-6 justify-center items-center">
                ...
                <div className="flex flex-col items-center">
                  <a href={`/policies/${state}`}>
                    <button className="mt-10 mb-10 py-1 px-5 shadow-md shadow-neutral-300 text-black text-lg sm-rounded border-8 border-double border-pcTan hover:scale-110 hover:shadow-lg hover:shadow-neutral-500">
                      Policies
                    </button>
                  </a>
                </div>
